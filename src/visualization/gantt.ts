import { ScheduledUnit } from '../domain/types';

export interface GanttOptions {
  width?: number;
  timeFormat?: 'minutes' | 'hours' | 'days';
  showWorkcenters?: boolean;
  showParts?: boolean;
}
...
export function generateGanttChart(
  ...
  const workcenterGroups = new Map<string, ScheduledUnit[]>();
...
export function generateASCIIGantt(units: ScheduledUnit[]): string {
